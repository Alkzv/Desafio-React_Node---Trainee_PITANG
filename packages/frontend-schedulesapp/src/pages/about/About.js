...
const About = () => (
  <div>
    ...
    <Text variant="gradient" gradient={{ from: "indigo", to: "cyan", deg: 45 }}>
      ...
      <i>
        Diante do cenário atual, existe uma demanda gigante de pessoas para
        tomar a vacina para o COVID-19. E com isso nossa cidade está precisando
        de um simples sistema para realizar os agendamentos. O processo consiste
        na criação de um portal onde será possível agendar pacientes para tomar
        a vacina, construir uma página para consulta dos agendamentos feitos por
        dia e horário.
      </i>
      ...
      <ol>
        ...
        <li>
          Cada horário só tem a disponibilidade de 2 agendamentos para o mesmo
          horário.
        </li>
      ...
      <ol>
        <li>
          O paciente deve informar seu nome, data de nascimento e dia e horário
          para o agendamento.
        </li>
        ...
        <li>
          Dentro da página para consultar os agendamentos deve ser possível
          visualizar a listagem de agendamentos feitos e informar se o
          agendamento foi realizado ou não, e qual a conclusão do atendimento(se
          foi realizado).
        </li>
        <li>
      ...
      <ol>
        <li>
          Portal escrito em React, utilizar o react-datepicker para o
