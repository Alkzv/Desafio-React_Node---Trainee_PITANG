...
//router.get('/schedule/', scheduleController.checkDayTimeAvailability.bind(scheduleController))
router.get('/schedule', scheduleController.getAll.bind(scheduleController))
// router.get('/schedule/:typeOrderBy', scheduleController.getAll.bind(scheduleController))
